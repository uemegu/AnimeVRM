  ...
  chapters: [
    {
      ...
      scenes: [
        ...
        // ============================================================
        {
          ...
          voiceUrl: resolveAssetUrl('/voices/teacher/walk_shion_1.wav'),
          scrollingBackground: {
            enabled: true,
        ...
        },
        {
          ...
          voiceUrl: resolveAssetUrl('/voices/teacher/walk_shion_2.wav'),
          scrollingBackground: {
            enabled: true,
            textureUrl: resolveAssetUrl('/textures/town_far.avif'),
            speed: 0.65,
        ...
        // --- ルートA: 先生に怒られるぞ ---
        {
          ...
          voiceUrl: resolveAssetUrl('/voices/teacher/walk_shion_scold.wav'),
          scrollingBackground: {
            enabled: true,
            textureUrl: resolveAssetUrl('/textures/town_far.avif'),
            speed: 0.65,
        ...
        // --- ルートB: マニアックだな ---
        {
          ...
          voiceUrl: resolveAssetUrl('/voices/teacher/walk_shion_maniac.wav'),
          scrollingBackground: {
            enabled: true,
            textureUrl: resolveAssetUrl('/textures/town_far.avif'),
            speed: 0.65,
        ...
        // ============================================================
        {
          ...
          voiceUrl: resolveAssetUrl('/voices/teacher/walk_teacher_greeting.wav'),
          scrollingBackground: {
            enabled: false,
          },
          cameraZoom: 'wide',
        ...
        },
        {
          ...
          voiceUrl: resolveAssetUrl('/voices/teacher/walk_shion_gate.wav'),
          cameraZoom: 'speaker_close',
        ...
        },
        {
          ...
          voiceUrl: resolveAssetUrl('/voices/teacher/walk_teacher_notice.wav'),
          cameraZoom: 'speaker_close',
        ...
        },
        {
          ...
          voiceUrl: resolveAssetUrl('/voices/teacher/walk_teacher_discover.wav'),
          cameraZoom: 'wide',
          cameraTransitionEasing: 'gyuin',
        ...
        },
        {
          ...
          voiceUrl: resolveAssetUrl('/voices/teacher/walk_shion_shock.wav'),
          cameraZoom: 'speaker_close',
          cameraTransitionEasing: 'gyuin',
          cameraTransitionDuration: 0.5,
          avatars: {
        ...
        },
        {
          ...
          voiceUrl: resolveAssetUrl('/voices/teacher/walk_teacher_geek.wav'),
          cameraZoom: 'speaker_close',
          cameraTransitionEasing: 'gyuin',
          cameraTransitionDuration: 0.4,
          avatars: {
        ...
        },
        {
          ...
          voiceUrl: resolveAssetUrl('/voices/teacher/walk_shion_passion.wav'),
          cameraZoom: 'wide',
          cameraTransitionEasing: 'smooth',
          cameraTransitionDuration: 0.5,
          avatars: {
        ...
        // ============================================================
        {
          ...
          voiceUrl: resolveAssetUrl('/voices/teacher/walk_teacher_calmdown.wav'),
          cameraZoom: 'speaker_close',
          cameraTransitionEasing: 'gyuin',
          cameraTransitionDuration: 0.5,
          avatars: {
        ...
        },
        {
          ...
          voiceUrl: resolveAssetUrl('/voices/teacher/walk_teacher_invite.wav'),
          cameraZoom: 'wide',
          cameraTransitionEasing: 'smooth',
          cameraTransitionDuration: 0.5,
          avatars: {
        ...
        },
        {
          ...
          background: resolveAssetUrl('/textures/school-gate-far.avif'),
          text: '「……！ 放課後……絶対行く……！ 先生、最高……」',
          voiceUrl: resolveAssetUrl('/voices/teacher/walk_shion_excited.wav'),
          cameraZoom: 'speaker_close',
          cameraTransitionEasing: 'gyuin',
          cameraTransitionDuration: 0.5,
          avatars: {
        ...
        },
        {
          ...
          voiceUrl: resolveAssetUrl('/voices/teacher/walk_teacher_condition.wav'),
          cameraZoom: 'speaker_close',
          cameraTransitionEasing: 'smooth',
          cameraTransitionDuration: 0.5,
          avatars: {
        ...
        },
        {
          ...
          voiceUrl: resolveAssetUrl('/voices/teacher/walk_shion_promise.wav'),
          cameraZoom: 'speaker_close',
          cameraTransitionEasing: 'gyuin',
          cameraTransitionDuration: 0.5,
          avatars: {
