  ...
  chapters: [
    {
      ...
      scenes: [
        ...
        // Scene 6: 彼女のささやき声
        {
          ...
          location: 'ドアスコープ越し (アパート前)',
          scenePreset: 'dark_indoor',
          voiceUrl: resolveAssetUrl('/voices/doorpeep_whisper.mp3'),
        ...
        // Scene 7: 1秒だけ歩いて近づいてくる演出（motionDuration: 1.0）
        {
          ...
          location: 'ドアスコープ越し (アパート前)',
          scenePreset: 'dark_indoor',
          voiceUrl: resolveAssetUrl('/voices/doorpeep_closer.mp3'),
        ...
        // Scene 8: 覗き穴への極限超接写（線伸びが解消されたクリアな円周魚眼！）
        {
          ...
          location: 'ドアスコープ越し (アパート前)',
          scenePreset: 'dark_indoor',
          voiceUrl: resolveAssetUrl('/voices/doorpeep_scream.mp3'),
        ...
        // Scene 10-A: 鍵を開けた結末
        {
          ...
          scenePreset: 'dark_indoor',
          background: resolveAssetUrl('/textures/apartment_door_far.avif'),
          voiceUrl: resolveAssetUrl('/voices/doorpeep_opendoor.mp3'),
        ...
        // Scene 10-B: 居留守を使った結末
        {
          ...
          location: 'ドアスコープ越し (アパート前)',
          scenePreset: 'dark_indoor',
          voiceUrl: resolveAssetUrl('/voices/doorpeep_silent.mp3'),
