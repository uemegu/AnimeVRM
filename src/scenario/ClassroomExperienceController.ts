...
export class ClassroomExperienceController {
  ...
  public async start(): Promise<void> {
    ...
    this.environment.add(this.createCourtyardBackdrop());
    this.environment.add(this.createChalkWriting());
    this.environment.add(this.createSunBeams());
    this.environment.add(this.createDustMotes());
    ...
    this.scene.background = new THREE.Color('#f3dcc0');
