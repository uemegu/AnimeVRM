  ...
  chapters: [
    {
      ...
      scenes: [
        ...
        // ============================================================
        {
          ...
          voiceUrl: resolveAssetUrl('/voices/pv_cut1_aoi.mp3'),
        ...
        // ============================================================
        {
          ...
          backgroundZoom: 1.0,
          voiceUrl: resolveAssetUrl('/voices/pv_cut2_aoi.mp3'),
        ...
        // ============================================================
        {
          ...
          voiceUrl: resolveAssetUrl('/voices/pv_cut3_emili.mp3'),
        ...
        // ============================================================
        {
          ...
          voiceUrl: resolveAssetUrl('/voices/pv_cut4_shion.mp3'),
        ...
        // ============================================================
        {
          ...
          voiceUrl: resolveAssetUrl('/voices/pv_cut5_aoi.mp3'),
        ...
        // ============================================================
        {
          ...
          voiceUrl: resolveAssetUrl('/voices/pv_cut6_emili.mp3'),
        ...
        // ============================================================
        {
          ...
          background: resolveAssetUrl('/textures/town_far.avif'),
          voiceUrl: resolveAssetUrl('/voices/pv_cut7_shion.mp3'),
        ...
        // ============================================================
        {
          ...
          voiceUrl: resolveAssetUrl('/voices/pv_cut8_all.mp3'),
        ...
        // ============================================================
        {
          ...
          scenePreset: 'evening_outdoor',
          background: resolveAssetUrl('/textures/town_far.avif'),
          voiceUrl: resolveAssetUrl('/voices/pv_cut9_daisuki.mp3'),
