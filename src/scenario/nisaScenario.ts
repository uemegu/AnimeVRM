  ...
  chapters: [
    {
      ...
      scenes: [
        ...
        // -------------------------------------------------------------
        {
          ...
          voiceUrl: '/voices/nisa_hold_01.wav',
          avatar: {
            motion: '/animations/Idle.fbx',
            expression: 'happy',
        ...
        // -------------------------------------------------------------
        {
          ...
          voiceUrl: '/voices/nisa_cash_01.wav',
          avatar: {
            motion: '/animations/Idle.fbx',
            expression: 'happy',
            expressionWeight: 0.8,
        ...
        // -------------------------------------------------------------
        {
          ...
          voiceUrl: '/voices/nisa_reva_01.wav',
          avatar: {
            motion: '/animations/Idle.fbx',
            expression: 'angry',
            expressionWeight: 0.85,
        ...
        // -------------------------------------------------------------
        {
          ...
          voiceUrl: '/voices/nisa_epilogue_01.wav',
          avatar: {
            motion: '/animations/Idle.fbx',
            expression: 'happy',
            expressionWeight: 1.0,
