...
export interface Translations {
  ...
  scenario: {
    ...
    silverWeekTitle: string;
    playSilverWeek: string;
    silverWeekDesc: string;
    gestureBattleTitle: string;
    playGestureBattle: string;
    gestureBattleDesc: string;
    corridorMobTitle: string;
    playCorridorMob: string;
    corridorMobDesc: string;
    paintedClassroomTitle: string;
    playPaintedClassroom: string;
    paintedClassroomDesc: string;
    paintedLibraryTitle: string;
    playPaintedLibrary: string;
    paintedLibraryDesc: string;
    cafeMonitoringTitle: string;
    playCafeMonitoring: string;
    cafeMonitoringDesc: string;
    liveStatus: string;
    sceneId: string;
    speaker: string;
  ...
  toasts: {
    ...
    silverWeekStarted: string;
    gestureBattleStarted: string;
    corridorMobStarted: string;
    paintedClassroomStarted: string;
    paintedLibraryStarted: string;
    cafeMonitoringStarted: string;
