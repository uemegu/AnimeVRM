...
export const TIME_OF_DAY_PRESETS: Record<TimeOfDayId, TimeOfDayPreset> = {
  ...
  // 5. 神聖・後光 (Divine Encounter) - 逆光シルエット & 黄金リムライト & 後光薄明光線
  divine: {
    id: 'divine',
    name: '神聖・後光',
    lighting: {
      ...
      sunShafts: {
        enabled: true,
        followDirectionalLight: false,
        sunPosition: { x: 0.0, y: 1.58, z: -2.2 },
        exposure: 0.42,
        decay: 0.9,
        density: 0.38,
        weight: 0.22,
    ...
    postProcessing: {
      ...
      cinematic: {
        ...
        adjustments: { saturation: 0.1, brightness: 0, contrast: 0.1 },
        vignette: { enabled: true, offset: 1.2, darkness: 0.25, color: '#05070e' },
        chromaticAberration: { enabled: true, offset: 0.0018 },
        sharpen: { enabled: true, amount: 0.15 },
      },
    },
    materials: {
      body: {
